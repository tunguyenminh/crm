(function($) {
    ...
    $.easyAjax = function(options) {
        ...
        function showResponseMessage(msg, type, toastrOptions) {
            ...
            if (opt.messagePosition == "toastr") {
                iziToast[type]({
                    title: headingClasses[type],
                    message: msg,
                    position: 'topRight'
                });
            }else if (opt.messagePosition == "none") {
        ...
        function handleFail(response) {
            ...
            if (typeof response.errors != "undefined") {
                ...
                $(opt.container).find(".has-error").find(".invalid-feedback").remove();
                $(opt.container).find(".has-error").find(".form-control").removeClass("is-invalid");
                ...
                if (opt.errorPosition == "field") {
                    for (var i = 0; i < keys.length; i++) {
                        ...
                        if (helpBlockContainer.length == 0 || $(ele).hasClass('ckeditor')) {
                            helpBlockContainer = $(grp);
                        }

                        helpBlockContainer.append('<div class="invalid-feedback">' + response.errors[keys[i]] + '</div>');
    ...
    $.ajaxModalWithHtml = function(selector, html, onLoad) {
    ...
    $.showErrors = function(object) {
        ...
        $(".has-error").find(".form-control").removeClass("is-invalid");
