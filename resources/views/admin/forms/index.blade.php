    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                <a href="{{ route('admin.forms.create') }}" class="btn btn-icon icon-left btn-primary"><i class="fa fa-plus"></i> @lang('module_form.addNewForm') </a>
            </div>
        </div>
    </div>
    @endif
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-striped" id="users-table" width="100%">
                            ...
                            <tr>
                                <th>@lang('app.id')</th>
                                <th>@lang('module_form.formName')</th>
                                <th>@lang('module_form.fields')</th>
    ...
    function deleteModal(id) {
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('admin.forms.destroy',':id') }}";
